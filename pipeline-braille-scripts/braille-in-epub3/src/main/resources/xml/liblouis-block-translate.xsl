...
<xsl:stylesheet version="2.0"
	...
	<xsl:template match="@alt" mode="identify-blocks treewalk">
		<xsl:attribute name="alt" select="louis:translate(concat('(locale:',(ancestor::*[@xml:lang][1]/@xml:lang/string(),'und')[1],')'), string(.))"/>
	</xsl:template>
