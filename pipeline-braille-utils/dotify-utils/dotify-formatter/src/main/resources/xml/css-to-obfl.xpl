...
<p:declare-step type="pxi:css-to-obfl"
    ...
    <px:message message="[progress pxi:css-to-obfl 2 pxi:css-to-obfl.for-each-padding]"/>
    <p:for-each>
        <px:message>
    ...
    <px:message message="[progress pxi:css-to-obfl 2 pxi:css-to-obfl.for-each-black-box]"/>
    <p:for-each>
        <px:message>
